...
assert.deepEqual(valid.map(x => x.date), [
...
assert.equal(validateMarketRows([
  { date: '2026-09-04T00:00:00.000Z', o: 100, h: 110, l: 95, c: 105, v: 100 },
  { date: '2026-09-04T00:00:00.000Z', o: 100, h: 111, l: 94, c: 106, v: 101 },
], now).length, 1);

const q = normalizeQuote({
  regularMarketPrice: 123.45,
  regularMarketTime: 1788600000,
  marketState: 'REGULAR',
