...
const readyAnalysis = { ...analysis, dataLimited: false, stock: { ...analysis.stock, dataLimited: false }, valuation: { ...analysis.valuation, verdict: 'FAIRLY VALUED' }, dataQuality: { confidence: 82, warnings: [], sectorFramework: { available: 7, total: 8 } }, score: { financialStrengthCoverage: 'FULL', sectorFramework: { available: 7, total: 8 }, overall: 84 }, technical: canonicalTechnical };
...
const technicalOnlyAnalysis = { ...readyAnalysis, fundamentals: undefined, valuation: { verdict: 'FAIRLY VALUED', fairValue: null } };
