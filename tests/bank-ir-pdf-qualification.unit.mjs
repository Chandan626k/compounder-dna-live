...
const base = {
  ...
  page: 4, table: 'Key performance metrics', documentVersion: null, extractedText: officialText,
};
...
const ambiguousPeriod = qualifyBankPdfText({ ...base, extractedText: 'Earnings Presentation. Standalone financial results. Net interest income.', fields: { nii: { value: 33530, unit: 'crore INR', currency: 'INR', reportedOrDerived: 'reported', context: 'Net interest income' } } });
...
const wrongUnit = qualifyBankPdfText({ ...base, fields: { nim: { value: 3.26, unit: 'crore INR', currency: 'INR', reportedOrDerived: 'reported', context: 'NIM' } } });
