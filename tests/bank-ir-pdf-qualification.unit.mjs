...
const base = {
  issuer: 'HDFC Bank Limited', ticker: 'HDFCBANK.NS', documentType: 'official-bank-pdf', documentTitle: 'Q1FY27 Earnings Presentation',
  documentDate: '2026-07-18', reportingPeriod: 'Q1 FY2027', periodType: 'Q1', statementScope: 'standalone',
  sourceUrl: 'https://www.hdfc.bank.in/about-us/investor-relations/financial-results', page: 4, table: 'Key performance metrics',
  documentVersion: null, extractedText: officialText,
};

const qualified = qualifyBankPdfText({ ...base, fields: { nii: { value: 33530, unit: 'crore INR', currency: 'INR', reportedOrDerived: 'reported', context: 'Net interest income' } } });
...
const ambiguousPeriod = qualifyBankPdfText({ ...base, extractedText: 'Q1FY27 Earnings Presentation. Standalone financial results. Net interest income.', fields: { nii: { value: 33530, unit: 'crore INR', currency: 'INR', reportedOrDerived: 'reported', context: 'Net interest income' } } });
...
const ambiguousScope = qualifyBankPdfText({ ...base, extractedText: 'Q1FY27 Earnings Presentation. Quarter ended June 30, 2026. Net interest income.', fields: { nii: { value: 33530, unit: 'crore INR', currency: 'INR', reportedOrDerived: 'reported', context: 'Net interest income' } } });
