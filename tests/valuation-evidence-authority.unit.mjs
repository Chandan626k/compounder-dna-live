...
const forward = (extra = {}) => record('ev_forward', 8.3, { periodType:'FORWARD', reportingPeriod:'FY2027E', ...extra });
const price = (extra = {}) => record('ev_price', 150, { periodType:'CURRENT', reportingDate:'2026-09-01', reportingPeriod:'CURRENT', ...extra });
