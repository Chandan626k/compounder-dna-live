...
const daily = {
  ...base, horizon: 'SWING', domain: 'technical', observationTimestamp: '2026-09-09T10:00:00Z',
...
assert.equal(resolveHorizonFreshness({ ...daily, observationTimestamp: '2026-09-09T10:00:00Z', observationBoundaryStatus: 'SUPERSEDED', currentEvidenceAvailable: false }).state, 'EXPIRED');
