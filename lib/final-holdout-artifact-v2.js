...
export function freezeResearchArtifact({ symbol, rows, candidateSearch }) {
  ...
  const artifact = {
    ...
    modelSelection: { method: 'FINAL_RESEARCH_WALK_FORWARD_WINDOW', window: selectedWindow.window,
    ...
    selectionTrace: windows.map(w => ({ window: w.window, trainStart: w.trainStart, trainEnd: w.trainEnd,
