...
export const buildStatementCoverage = (evidence) => ({ income: hasReturnedValue(evidence?.income), balanceSheet: hasReturnedValue(evidence?.balance), cashFlow: hasReturnedValue(evidence?.cash) });
