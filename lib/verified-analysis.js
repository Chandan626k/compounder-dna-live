...
export async function analyzeVerified(input) {
  ...
  return {
    ...
    provenance: {
      ...
      currentQuote: currentQuote ? { source: currentQuote.provider || 'Yahoo Finance quote API', price: currentQuote.price, observedAt: currentQuote.observedAt, retrievedAt: currentQuote.retrievedAt, marketState: currentQuote.marketState, exchangeDataDelayedBy: currentQuote.exchangeDataDelayedBy, quoteSourceName: currentQuote.quoteSourceName, status: currentQuote.status } : null,
