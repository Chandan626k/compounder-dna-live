...
export function createNseCalendarAdapter(options = {}) {
  return createAdapter({ exchange: 'NSE', source: 'NSE', authorityClass: 'NSE_EXCHANGE_CALENDAR', ...options });
}

export function createBseCalendarAdapter(options = {}) {
  return createAdapter({ exchange: 'BSE', source: 'BSE', authorityClass: 'BSE_EXCHANGE_CALENDAR', ...options });
}
